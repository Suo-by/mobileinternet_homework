...
public class NoteViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bind(final Note note) {
        ...
        switch (note.getPriority()){
            case 0:
                itemView.setBackgroundColor(Color.parseColor("#333369"));
                break;
            case 1:
                itemView.setBackgroundColor(Color.parseColor("#333399"));
                break;
            case 2:
                itemView.setBackgroundColor(Color.parseColor("#3366FF"));
                break;
            case 3:
                itemView.setBackgroundColor(Color.parseColor("#6699FF"));
                break;
            default:
